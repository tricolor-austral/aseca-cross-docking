...
CREATE TABLE "SubOrder" (
    ...
    "productAmmountId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "SubOrder" ADD CONSTRAINT "SubOrder_productAmmountId_fkey" FOREIGN KEY ("productAmmountId") REFERENCES "ProductAmmount"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
